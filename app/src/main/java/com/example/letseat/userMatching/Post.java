...
public class Post {
    ...
    * */
    public static void makePost(String restaurantImgUrl, String restaurantName, String restaurantLocation, String userEmail, String time, String message, ArrayList<String> label){
